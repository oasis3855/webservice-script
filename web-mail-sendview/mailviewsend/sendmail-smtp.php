...
<head>
<title>PHP Mail (Net_SMTP)</title>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
</head>
<body style="font-size:11pt; background-color:#e6e6e6">
<?php

printf("<p>メール送信（smtp版）システム Version %s</p>\n", $str_version);
...
function sendmail_sendmsg($account_no, $subject, $rcpt, $fromname, $msg, $debug_flag)
{
    ...
    printf("<p>message header</p>\n<pre>%s</pre>\n", htmlspecialchars($str_smtp_data));
    ...
    {
        print("<pre>\n" . htmlspecialchars(print_r($smtp->getResponse()), true) . "\n</pre>\n");
